...
<head>
    ...
    <link rel="preload" fetchpriority="high" as="image" href="/cms.bannerctr/download?namaFile=rsbjx2lc9no6ifzoe3-slider-3.jpg" >
    ...
    <link rel="stylesheet" media="screen" href="/public/stylesheets/ekko-lightbox.min.css">
    <link rel="stylesheet" media="screen" href="/public/stylesheets/jquery-ui.min.css">
    <link rel="stylesheet" media="screen" href="/public/plugins/spinner/dist/loading.min.css">
    <link rel="stylesheet" media="screen" href="/public/stylesheets/datetimepicker.css"/>
    ...
    <div class="main-header-wrapper">
        <div class="helper-menu">
            <div class="container-fluid">
                <ul>
                    <li><a href="/language/change?lang=id"><img alt="E-Katalog LKPP" width="15px" height="15px" src="/public/images/id.png" style="width: 15px; height: 15px"></a> |
                        <a href="/language/change?lang=en"><img alt="E-Katalog LKPP" width="15px" height="15px" src="/public/images/en.png" style="width: 15px; height: 15px"></a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/">
                            <img alt="E-Katalog LKPP" width="101px" height="30px" src="/public/images/nav_logo.png" class="img img-responsive"/>
                        </a>
                    </div>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel" style="height: 250px">
            ...
            <div class="carousel-inner">
                ...
                <div class="item" style="width: 100%;max-height: 250px">
                    <img alt="E-Katalog LKPP" width="1110px" height="250px" style="width: 100%; height: 250px" src="/cms.bannerctr/download?namaFile=rsbjx2lc9no6ifzoe3-slider-3.jpg" onerror="this.src='/cms.bannerctr/download?namaFile=slider-image-not-found.jpg';"/>
                </div>
        ...
        <div class="row nav-tab">
            <a href="/publikctr/popularcommoditylist?jenis=Nasional">
                <div class="col-md-2 col-sm-2 col-xs-2 comp-category active" title="Etalase Produk Nasional">
                    <div class="wrapper">
                        <img alt="E-Katalog LKPP" width="24px" height="24px" src="/public/img/k-nasional.svg">
            ...
            <a href="/publikctr/popularcommoditylist?jenis=Lokal">
                <div class="col-md-2 col-sm-2 col-xs-2 comp-category active" title="Etalase Produk Lokal">
                    <div class="wrapper">
                        <img alt="E-Katalog LKPP" width="24px" height="24px" src="/public/img/k-lokal.svg">
            ...
            <a href="/publikctr/popularcommoditylist?jenis=Sektoral">
                <div class="col-md-2 col-sm-2 col-xs-2 comp-category active" title="Etalase Produk Sektoral">
                    <div class="wrapper">
                        <img alt="E-Katalog LKPP" width="24px" height="24px" src="/public/img/k-sektoral.svg">
            ...
            <a href="/publikctr/popularcommoditylist?jenis=UKM">
                <div class="col-md-2 col-sm-2 col-xs-2 comp-category active" title="Etalase Produk UKM">
                    <div class="wrapper">
                        <img alt="E-Katalog LKPP" width="24px" height="24px" src="/public/img/k-ukm.svg" alt="">
            ...
            <a href="/publikctr/popularcommoditylist?jenis=Inovasi">
                <div class="col-md-2 col-sm-2 col-xs-2 comp-category active" title="Etalase Produk Inovasi">
                    <div class="wrapper">
                        <img alt="E-Katalog LKPP" width="24px" height="24px" src="/public/img/k-inovasi.svg">
            ...
            <a href="/publikctr/popularcommoditylist?jenis=TKDN">
                <div class="col-md-2 col-sm-2 col-xs-2 comp-category active" title="Etalase Produk TKDN">
                    <div class="wrapper">
                        <img alt="E-Katalog LKPP" width="24px" height="24px" src="/public/img/bbi.svg">
...
<!-- End Komoditas -->
    ...
    <div class="card-item" style="height: 366px;">
        <div class="card-item-image">
                ...
                <img alt="E-Katalog LKPP" width="239px" height="93px" style="width: 100%; height: 93px" src="/public/images/katlokal-02.jpg" class="img img-responsive" onerror="this.src='/public/images/placeholder.png';"/>
    ...
    <div class="card-item" style="height: 366px;">
        <div class="card-item-image">
                ...
                <img alt="E-Katalog LKPP" width="239px" height="93px" style="width: 100%; height: 93px" src="/public/images/katsektoral-01.jpg" class="img img-responsive" onerror="this.src='/public/images/placeholder.png';"/>
            ...
            <div class="card-item" style="height: 366px;">
                <div class="card-item-image">
                    ...
                    <a href="/berita/baca-berita/1839/Pengumuman-Vendor-Conference-Kementerian-Kesehatan">
                        ...
                        <img alt="E-Katalog LKPP" width="239px" height="139px" style="width: 100%; height: 139px" class="img img-responsive" src="/cms/berita/download/gambar-compresses/1839?namaFile=51179444749195.png&amp;width=239&amp;height=139" onerror="this.src='/public/images/placeholder.png';"/>
                    </a>
            ...
            <div class="card-item" style="height: 366px;">
                <div class="card-item-image">
                    ...
                    <a href="/berita/baca-berita/1838/Pengumuman-Pemberian-Label-Official-Vendor-PT-Sejahtera-Wahana-Gemilang-PPNAOVR214--">
                        ...
                        <img alt="E-Katalog LKPP" width="239px" height="139px" style="width: 100%; height: 139px" class="img img-responsive" src="" onerror="this.src='/public/images/placeholder.png';"/>
                    </a>
            ...
            <div class="card-item" style="height: 366px;">
                <div class="card-item-image">
                    ...
                    <a href="/berita/baca-berita/1836/Pemberitahuan-Pengadaan-Antropometri-Kit-Di-Lingkungan-Kantor-Pusat-Kementerian-Kesehatan">
                        ...
                        <img alt="E-Katalog LKPP" width="239px" height="139px" style="width: 100%; height: 139px" class="img img-responsive" src="/cms/berita/download/gambar-compresses/1836?namaFile=244668532050857.png&amp;width=239&amp;height=139" onerror="this.src='/public/images/placeholder.png';"/>
                    </a>
