...
<div class="container-fluid detail-package">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="toolbar">
				<a href="/v2/purchasing/paket" class="btn btn-default" style="margin-right: 1rem;"><i aria-hidden="true" class="fa fa-arrow-circle-left"></i> Daftar Paket</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;" onclick="window.location='{{ url("/downIoad2") }}'">Cetak Detail Paket</button><a href="/v2/id/purchasing/paket/8288704/daftar-produk" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Produk</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;">Proses Negosiasi</button><a href="/v2/id/purchasing/paket/8288704/tetapkan-distributor" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Menetapkan Distributor</a><a href="/v2/id/purchasing/paket/8288704/daftar-kontrak" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Kontrak</a><a href="/v2/id/purchasing/paket/8288704/riwayat-pengiriman-penerimaan" class="btn btn-primary" style="margin-right: 1rem;">Riwayat Pengiriman &amp; Penerimaan</a>
			</div>
		</div>
	</div>
	<div class="row">
											...
											<div class="detail-list">
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">BUFFERSTOK PERSEDIAAN PERALATAN KEBENCANAAN</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">ID Paket</div>
														<div class="detail-description col-md-8">4291204005-KD-186110036</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">46689187</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">Pekerjaan Belanja Penyediaan Bahan Bufferstok Persediaan Peralatan Kebencanaan</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">
															<div style="padding-left: 0px;">Rp&nbsp;11.500.000.000,00</div>
														</div>
													</div>
												</div>
												<div class="detail-item">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">10 Januari 2024</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
											...
											<div class="detail-list">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">198-50313-2009-121-001
</div>
													</div>
												</div>
												<div class="detail-item">
								...
								<div class="detail-list">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;9.900.000.000,00</div>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Henry Hizkia</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;9.000.000.000,00</div>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;9.750.000.000,00</div>
											</div>
											<div class="detail-description col-md-1">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Henry Hizkia</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;9.350.000.000,00</div>
											</div>
											<div class="detail-description col-md-1">
												<i class="fa fa-check-circle-o"></i>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">PT. Adilawe Apin Tawa</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;9.600.000.000,00</div>
											</div>
											<div class="detail-description col-md-1">
												<i class="fa fa-check-circle"></i>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Henry Hizkia</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;9.442.490.000,00</div>
											</div>
											<div class="detail-description col-md-1">
								...
								<div class="detail-list">
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-8">Disetujui 10 Januari 2024</div>
										</div>
									</div>
									<div class="detail-item">
										<div class="row">
