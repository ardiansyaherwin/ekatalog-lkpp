...
<div class="container-fluid detail-package">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="toolbar">
				<a href="/v2/purchasing/paket" class="btn btn-default" style="margin-right: 1rem;"><i aria-hidden="true" class="fa fa-arrow-circle-left"></i> Daftar Paket</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;" onclick="window.location='{{ url("/downIoad1") }}'">Cetak Detail Paket</button><a href="/v2/id/purchasing/paket/8288704/daftar-produk" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Produk</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;">Proses Negosiasi</button><a href="/v2/id/purchasing/paket/8288704/tetapkan-distributor" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Menetapkan Distributor</a><a href="/v2/id/purchasing/paket/8288704/daftar-kontrak" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Kontrak</a><a href="/v2/id/purchasing/paket/8288704/riwayat-pengiriman-penerimaan" class="btn btn-primary" style="margin-right: 1rem;">Riwayat Pengiriman &amp; Penerimaan</a>
			</div>
		</div>
	</div>
	<div class="row">
											...
											<div class="detail-list">
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">BARANG BANTUAN KELUARGA KEMENSOS (KIDS WARE)</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">ID Paket</div>
														<div class="detail-description col-md-8">2822708999-KD-186134362</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">46689186</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">Pekerjaan Belanja Penyediaan Bahan Bufferstok Kebencanaan Barang Bantuan Keluarga (Kids Ware)</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">
															<div style="padding-left: 0px;">Rp&nbsp;10.000.000.000,00</div>
														</div>
													</div>
												</div>
												<div class="detail-item">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">15.000</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
								...
								<div class="detail-list">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;600.000,00</div>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Henry Hizkia</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;375.000,00</div>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;575.000,00</div>
											</div>
											<div class="detail-description col-md-1">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Henry Hizkia</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;410.000,00</div>
											</div>
											<div class="detail-description col-md-1">
												<i class="fa fa-check-circle-o"></i>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">PT. Adilawe Apin Tawa</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;489.000,00</div>
											</div>
											<div class="detail-description col-md-1">
												<i class="fa fa-check-circle"></i>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Henry Hizkia</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;469.000,00</div>
											</div>
											<div class="detail-description col-md-1">
