...
<div class="container-fluid detail-package">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="toolbar">
				<a href="/v2/purchasing/paket" class="btn btn-default" style="margin-right: 1rem;"><i aria-hidden="true" class="fa fa-arrow-circle-left"></i> Daftar Paket</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;">Cetak Detail Paket</button><a href="/v2/id/purchasing/paket/8288704/daftar-produk" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Produk</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;">Proses Negosiasi</button><a href="/v2/id/purchasing/paket/8288704/tetapkan-distributor" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Menetapkan Distributor</a><a href="/v2/id/purchasing/paket/8288704/daftar-kontrak" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Kontrak</a><a href="/v2/id/purchasing/paket/8288704/riwayat-pengiriman-penerimaan" class="btn btn-primary" style="margin-right: 1rem;">Riwayat Pengiriman &amp; Penerimaan</a>
			</div>
		</div>
	</div>
	<div class="row">
											...
											<div class="detail-list">
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">Barang Elektronik Majelis Permusyawaratan Rakyat</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">ID Paket</div>
														<div class="detail-description col-md-8">BEJ-P2312-8288704</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">43874117</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Produk Wilayah</div>
														<div class="detail-description col-md-8">Kota Jakarta Pusat</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Nama Paket</div>
														<div class="detail-description col-md-8">Pengadaan Peralatan Fasilitas Perkantoran (CCTV)</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">
															<div style="padding-left: 0px;">Rp&nbsp;287.350.000,00</div>
														</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">Majelis Permusyawaratan Rakyat</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Satuan Kerja</div>
														<div class="detail-description col-md-8">SEKRETARIAT JENDERAL</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">NPWP Satuan Kerja</div>
														<div class="detail-description col-md-8">00.098.731.3-077000</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">
															-Jl. Jenderal Gatot Subroto No 6 Jakarta Pusat - Kota Jakarta Pusat - DKI Jakarta
														</div>
													</div>
												</div>
												<div class="detail-item">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">14 December 2023</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">2023</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Total Produk</div>
														<div class="detail-description col-md-8">1</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">
															<div style="padding-left: 0px;">Rp&nbsp;143.800.000,00</div>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="detail-list">
												<div class="detail-item">
													<div class="row">
														...
														<div class="detail-description col-md-8">Udi Hartadi (PP_MPR_0003)</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Jabatan</div>
														<div class="detail-description col-md-8">kasubag pengadaan</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">NIP</div>
														<div class="detail-description col-md-8">197212312006041009</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Email</div>
														<div class="detail-description col-md-8">udi.hartadi@setjen.mpr.go.id</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">No. Telp</div>
														<div class="detail-description col-md-8">02157895067</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
										...
										<div role="tabpanel" class="tab-pane">
											...
											<div class="detail-list">
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Nama</div>
														<div class="detail-description col-md-8">Rosy Romadiana Pasaribu (PPK-101402)</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Jabatan</div>
														<div class="detail-description col-md-8">Kepala Bagian Pemeliharaan, Instalasi, dan Angkutan</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">NIP</div>
														<div class="detail-description col-md-8">198107062009012003</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">Email</div>
														<div class="detail-description col-md-8">rosy.pasaribu@setjen.mpr.go.id</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">No. Telp</div>
														<div class="detail-description col-md-8">6282112399503</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
												...
												<div class="detail-list">
													<div class="detail-item">
														<div class="row">
															<div class="detail-heading col-md-4">Nama</div>
															<div class="detail-description col-md-8">
																<a href="/v2/id/purchasing/paket/8288704/info-penyedia/1006101">PT INDI DAYA NUSAREKA</a>
															</div>
														</div>
													</div>
													<div class="detail-item">
														<div class="row">
															...
															<div class="detail-description col-md-8">947226478416000</div>
														</div>
													</div>
													<div class="detail-item">
														<div class="row">
															...
															<div class="detail-description col-md-8">
																Green Lake City Rukan Great Wall Blok B/019 Kelurahan Gondrong Kecamatan Cipondoh Kota Tangerang
															</div>
														</div>
													</div>
													<div class="detail-item">
													...
													<div class="detail-item">
														<div class="row">
															<div class="detail-heading col-md-4">Email</div>
															<div class="detail-description col-md-8">info@indidayanusareka.com</div>
														</div>
													</div>
													<div class="detail-item">
														<div class="row">
															<div class="detail-heading col-md-4">No. Telp</div>
															<div class="detail-description col-md-8">02157991920</div>
														</div>
													</div>
													<div class="detail-item">
														<div class="row">
												...
												<div class="detail-list">
													<div class="detail-item">
														<div class="row">
															<div class="detail-heading col-md-4">Nama</div>
															<div class="detail-description col-md-8">
																<a href="/v2/id/purchasing/paket/8288704/info-distributor/1121571">PT INDI DAYA NUSAREKA</a>
															</div>
														</div>
													</div>
													<div class="detail-item">
														<div class="row">
															<div class="detail-heading col-md-4">NPWP</div>
															<div class="detail-description col-md-8">94.722.647.8-416.000</div>
														</div>
													</div>
													<div class="detail-item">
														<div class="row">
													...
													<div class="panel-group">
														<div class="detail-item">
															<div class="row">
																...
																<div class="detail-description col-md-4">Kode Anggaran</div>
															</div>
														</div>
														<div class="detail-item">
															<div class="row">
																<div class="detail-heading col-md-4">APBN</div>
																<div class="detail-description col-md-4">WA.1014.EBB.951.051.0A.532111</div>
															</div>
														</div>
													</div>
												</div>
								...
								<div class="detail-list">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Udi Hartadi</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;149.336.143,00</div>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Udi Hartadi</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;140.000.000,00</div>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">PT INDI DAYA NUSAREKA</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;147.000.000,00</div>
											</div>
											<div class="detail-description col-md-1">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">Udi Hartadi</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;141.750.000,00</div>
											</div>
											<div class="detail-description col-md-1">
												<i class="fa fa-check-circle-o"></i>
											</div>
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-6">PT INDI DAYA NUSAREKA</div>
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;144.500.000,00</div>
											</div>
											<div class="detail-description col-md-1">
												<i class="fa fa-check-circle"></i>
											</div>
								...
								<div class="detail-list">
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-4">1</div>
										</div>
									</div>
									<div class="detail-item">
										<div class="row">
								...
								<div class="detail-list">
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-8">Disetujui 14 December 2023</div>
										</div>
									</div>
									<div class="detail-item">
										<div class="row">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-8">PT INDI DAYA NUSAREKA</div>
										</div>
									</div>
								</div>
							</div>
	...
	<div style="position: fixed; z-index: 9999; inset: 16px; pointer-events: none;"></div>
        ...
        <script src="/public/rjs/bundle.js?v=2023.24.2" type="text/javascript"> </script>
