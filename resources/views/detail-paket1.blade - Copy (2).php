...
<div class="container-fluid detail-package">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="toolbar">
				<a href="/v2/purchasing/paket" class="btn btn-default" style="margin-right: 1rem;"><i aria-hidden="true" class="fa fa-arrow-circle-left"></i> Daftar Paket</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;" onclick="window.location='{{ url("/downIoad") }}'">Cetak Detail Paket</button><a href="/v2/id/purchasing/paket/8288704/daftar-produk" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Produk</a><button class="btn btn-sm btn-warning" style="margin-right: 1rem;">Proses Negosiasi</button><a href="/v2/id/purchasing/paket/8288704/tetapkan-distributor" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Menetapkan Distributor</a><a href="/v2/id/purchasing/paket/8288704/daftar-kontrak" class="btn btn-sm btn-warning" style="margin-right: 1rem;">Daftar Kontrak</a><a href="/v2/id/purchasing/paket/8288704/riwayat-pengiriman-penerimaan" class="btn btn-primary" style="margin-right: 1rem;">Riwayat Pengiriman &amp; Penerimaan</a>
			</div>
		</div>
	</div>
	<div class="row">
										...
										<div role="tabpanel" class="tab-pane">
											...
											<div class="detail-list">
												...
												<div class="detail-item">
													<div class="row">
														<div class="detail-heading col-md-4">NIP</div>
														<div class="detail-description col-md-8">198107062009012000</div>
													</div>
												</div>
												<div class="detail-item">
													<div class="row">
									...
									<div class="detail-item">
										<div class="row">
											...
											<div class="detail-description col-md-3">
												<div style="padding-left: 0px;">Rp&nbsp;0,00</div>
											</div>
